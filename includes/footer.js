include( `
    <footer class="page-footer" style="background-color: #e2001a;" id="footer">
        <div class="container">
            <div class="row">
                <div class="col l2 s12">
                    <h5 class="white-text">Nos parcours</h5>

                    <p class="grey-text text-lighten-4">
                        <ul>
                            <li><a target="_blank" class="white-text" href="https://makerslab.em-lyon.com/fr/formations.html">Conception web</a></li>
                            <li><a target="_blank" class="white-text" href="https://makerslab.em-lyon.com/fr/formations.html">Fabrication numérique</a></li>
                            <li><a target="_blank" class="white-text" href="https://makerslab.em-lyon.com/fr/formations.html">Objets connectés</a></li>
                            <li><a target="_blank" class="white-text" href="https://makerslab.em-lyon.com/fr/formations.html">Intelligence Artificielle</a></li>
                        </ul>
                    </p>
                </div>

                <div class="col l2 s12">
                    <h5 class="white-text">Nos campus</h5>
                ...
                <div class="col l4 s12">
                    ...
                    <p class="grey-text text-lighten-4">
                        <b>la toile</b> est une formation portée par l'&#198;SCRA, une association à but non lucratif qui vise à réduire des inégalités sociales ou culturelles en développant des formations professionnelles accessibles au plus grand nombre.
                    </p>
                </div>
